...
- **latest**: contains the SharePoint Framework Yeoman generator from the [1.23.0](https://docs.microsoft.com/sharepoint/dev/spfx/release-1.23) release
- **online**: contains the SharePoint Framework Yeoman generator from the [1.23.0](https://docs.microsoft.com/sharepoint/dev/spfx/release-1.23) release
