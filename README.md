...
### Can't access bundles in SharePoint Framework >=1.13.0

Modify `node_modules\@microsoft\spfx-heft-plugins\lib\plugins\webpackConfigurationPlugin\WebpackConfigurationGenerator.js`
...
### Can't access workbench and bundles in SharePoint Framework =1.12.1
